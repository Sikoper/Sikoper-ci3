...
<head>
    ...
    <title>Kwitansi Penarikan - <?= $no_rekening ?></title>
    <style>
        @page {
            size: 28cm 9cm;
            margin: 5mm;
    ...
    <div class="kwitansi-container">
        <div class="kwitansi-header">
            ...
            <div class="kwitansi-number">
                <strong>BUKTI PENARIKAN</strong><br>
                No: <?= $no_kwitansi ?><br>
        ...
        <div class="kwitansi-body">
            ...
            <div class="amount-section">
                <div class="amount-box">
                    <div class="label-text">JUMLAH PENARIKAN</div>
                    <div class="amount">Rp <?= number_format($jumlah_penarikan, 0, ',', '.') ?></div>
                    <div class="terbilang">(<?= ucwords($terbilang) ?>)</div>
                </div>
                <div class="sisa-saldo">
                    <strong>Sisa Saldo:</strong> Rp <?= number_format($sisa_saldo, 0, ',', '.') ?>
                </div>
            </div>
        </div>
