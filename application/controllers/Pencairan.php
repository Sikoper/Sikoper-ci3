...
class Pencairan extends CI_Controller
{
    ...
    public function get_saldo($simpanan_id)
    {
        ...
        if ($simpanan) {
            echo json_encode(['saldo' => $simpanan->jumlah_deposito]);
        } else {
    ...
    {
        $tanggal_deposito_input = $this->input->post('tanggal_deposito');
        ...
        if (!empty($simpanan_id)) {
            ...
            if (!empty($simpanan_data)) {
                ...
                if (!empty($jenis_tabungan_data)) {
                    ...
                    $date_of_withdrawal_dt = new DateTime($tanggal_deposito_input);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data_penarikan_header = [
                ...
                'tanggal_deposito' => $tanggal_deposito_input,
    ...
    public function detail($encoded_rek = null)
    {
        ...
        $simpanan = $this->deposito_model->get_data_by_norek($no_rekening);
    ...
    public function fetch_detail_penarikan_by_simpanan()
    {
        ...
        foreach ($list as $item) {
            ...
            $rowData[] = date('d-m-Y', strtotime($item->tanggal_deposito));
    ...
    public function hapus_detail_penarikan_ajax()
    {
        ...
        if ($deleted_header) {
            $kriteria_hapus_detail = [
                'simpanan_id'       => $penarikan_header_data->simpanan_id,
                'tanggal_deposito' => $penarikan_header_data->tanggal_deposito,
